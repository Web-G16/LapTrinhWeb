  ...
  .controller( "RegisterCtrl",['$scope', function($scope) {
    ...
    <!--End Header section  -->
		<sql:setDataSource var="dbsource" driver="com.mysql.jdbc.Driver"
					url="jdbc:mysql://node179275-group16.jelastic.servint.net/data" user="root" password="FZDool70036" />
  ...
  <div class="col-sm-9">
    <div class="row">
        ...
        <c:forEach var="row" items="${result.rows}">
         ...
         <p> <marquee height=10% scrollamount=1 direction="up"> + <c:out value="${row.NgayThongBao }"/>  <c:out value="${row.TenMonHoc }"/> <c:out value="${row.NoiDungThongBao }"/></marquee></p>
