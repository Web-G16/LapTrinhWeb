	...
	<sql:setDataSource var="dbsource" driver="com.mysql.jdbc.Driver"
         	...
         	select *
				...
				from baigiang,khoahoc
						...
						where baigiang.IDKH=${param.id}  and baigiang.IDKH = khoahoc.IDKH
        ...
        <div class="post">
          <div class="panel panel-default">
            <div class="panel-heading">
              <p style="color:#097e23;font-size:25px">Các bài giảng</p>
            </div>
            <div class="panel-body">
                ...
                <ul>
                  <h3><li><a href="HVbaigiang.jsp?id=<c:out value="${row.ID}" />"><c:out value="${row.Tuan}" /></a></li></h3>
