  ...
  .controller( "RegisterCtrl",['$scope', function($scope) {
	...
	<sql:query dataSource="${dbsource}" var="result">
         	select *
				...
				from baigiang,khoahoc
				
								
						where ID=${param.id} and baigiang.IDKH=khoahoc.IDKH
					...
					<div class="post">
						<div class="panel panel-default">
							<div class="panel-heading">
								<p style="color: #097e23; font-size: 25px">Bài giảng</p>
							</div>
							<div class="panel-body">

								<div class="col-md-12 sidebar" style="border: 1px solid black">
									<c:forEach var="row" items="${result.rows}">
										<table class="table table-striped">
											...
											<tbody>
												<tr>
													<td><center>
															<p style="color: red; font-size: 16px; margin-left: 0px;">
																<c:out value="${row.TenBaiGiang}" />
															</p>
														</center>
														<div class="col-md-12">
															<iframe width="600" height="380"
																src="<c:out value="${row.LinkVideo}" />" frameborder="0"
																allowfullscreen></iframe>
														</div>
														<p style="margin-left: 0px" class="text-center">
															-Tài liệu:
															<c:out value="${row.decuong}" />
															<a href="downtailieu.jsp?id=<c:out value="${row.ID}"/>">Tải</a>
														</p></td>
												</tr>
											</tbody>
										</table>
