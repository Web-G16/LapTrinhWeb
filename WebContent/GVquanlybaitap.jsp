				...
				<div class="col-sm-9">
					<div class="row">
						...
						<div class="col-md-12" style="border: 1px solid black">
							...
							<center><h3 class="tieude">Quản lý khóa học - Bài tập</h3></center>
							...
							<c:forEach var="row" items="${result.rows}">
										<tbody>
											...
											<tr>
												...
												<td><c:out value="${row.TenBaiTap}" /></td>
												
												<td><a class="btn btn-primary btn-xs" href="GVsuabaitap.jsp?ID=<c:out value="${row.ID}" />"><span
															class="glyphicon glyphicon-pencil"></span>Sửa</a></td>
												<td><a class="btn btn-danger btn-xs"  href="javascript:confirmGo('Bạn muốn xóa bài tập này?','xoabt.jsp?id=<c:out value="${row.ID}"/>&IDKH=<c:out value="${row.IDKH}"/>')"><span
							...
							<table class="table table-striped">
							<div class="col-md-4">
									<form method="post" enctype="multipart/form-data" action="upbt">
									...
									<span><i
										class="glyphicon glyphicon-pencil"> </i> Tên bài tập </span>
									 <input
										type="text" name="TenBaiTap" class="form-control"
