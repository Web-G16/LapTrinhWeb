  ...
  <div class="col-sm-9">
    <div class="row">
        ...
        <ul>
           <c:choose>
        <c:when test="${count>=1}">
            <font size="5" color='green'> Sửa bài thi thành công</font>
              <a href="GVdethi.jsp?IDKH=${param.idkh }">Quay lại</a>          
        </c:when>
        <c:otherwise>
        	<center><font size="5" color='green'> Sửa bài thi không thành công</font></center>
             <center><a href="GVdethi.jsp?IDKH=${param.idkh }">Quay lại</a>  </center>
        </c:otherwise>
        </c:choose>
        </ul>
      </div>
