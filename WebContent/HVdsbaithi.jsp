    ...
    <!--End Header section  -->
		<sql:setDataSource var="dbsource" driver="com.mysql.jdbc.Driver"
     			...
     			<sql:query dataSource="${dbsource}" var="result">
         				   ...
         				   from khoahoc,baithi,dkkh 
         				   where khoahoc.IDKH=baithi.idkh and khoahoc.IDKH=dkkh.IDKH and baithi.idkh=dkkh.IDKH;
...
<div class="row">
  ...
  <div class="col-sm-9">
    <div class="row">
       <center><h3 class="tieude">Danh sách các bài thi</h3></center>
							...
							<tbody>
								...
								<tr>
									...
									<td><a class="btn btn-primary btn-xs" 
										href="HVlambaithi.jsp?idkh=
										<c:out value="${row.IDKH}"/>&id=<c:out value="${row.id}"/>">
