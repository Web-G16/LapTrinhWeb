...
<%@ page import="javax.mail.internet.*,javax.activation.*"%>
 <%
      ...
      String user=request.getParameter("from");//Your E-mail-Id
      String pass=request.getParameter("pass");     //your e-mail account password

String SSL_FACTORY = "javax.net.ssl.SSLSocketFactory";
String to = request.getParameter("to"); //recipient E-mail-Id
String from = request.getParameter("from"); // Your E-mail Id
