		...
		<sql:setDataSource var="dbsource" driver="com.mysql.jdbc.Driver"
         	...
         	select *
				...
				from baitap,khoahoc
						...
						where ID=${param.id} and khoahoc.IDKH=baitap.IDKH
        ...
        <div class="post">
          <div class="panel panel-default">
            <div class="panel-heading">
              <p class="panel-little " style="color:#7dc5f3;font-size:20px">Bài tâp</p>
            </div>
            <div class="panel-body">

                <div class="col-sm-12 sidebar" style="border:1px solid black">
                  <table class="table table-striped">
					 <c:forEach var="row" items="${result.rows}">
                    <tr>
                      <td><p style="color:red; font-size:16px;">Chương I. ứng dụng đạo hàm để khào sát và vẽ đồ thị</p>
                      <h3>-Bài tập: </h3>
                        <h3><c:out value="${row.TenBaiTap}" /> <a href="downbt.jsp?id=<c:out value="${row.ID}"/>">tải</a></h3>
                        
                      </td>
                    </tr>
                    <tr>
                      <td>
                      <form method="post" enctype="multipart/form-data" action="nopbt">
                      							 <div class="form-group">
                                              <h3><label for="exampleInputName1">Tuần:</label></h3>
                                              <input type="hidden" name="user"  value="<%=session.getAttribute("userid")%>"/>
                                              <input type="hidden" name="IDKH" value="<c:out value="${row.IDKH}"/>">
                                              <input type="text" name="Tuan" class="form-control" id="exampleInputName1" placeholder="Nhập Tiêu đề">
                                              </div>
                                              <div class="form-group">
                                              <label for="exampleInputName1">Tên bài tập (viết theo định dạng ' Tuần.docx ' ) :</label>
                                              <input type="text" name="TenBaiTap" class="form-control" id="exampleInputName1" placeholder="Nhập Tiêu đề">
                                              </div>
        
                                              <div class="form-group">
                                              <label for="exampleInputFile">Duyệt</label>
                                              <input type="file" name="link" id="exampleInputFile">
                                              </div>
                                              <div class="checkbox">
                                              </div>
