...
<body>
  ...
  .controller( "RegisterCtrl",['$scope', function($scope) {
	...
	<div class="container" id="home">
		<div class="row text-center">
			<div class="col-md-12">
				...
				<button style="margin-bottom: 100px" class="btn btn-default-1">Tham
					gia ngay</button>
			</div>
	...
	<sql:query dataSource="${dbsource}" var="result">
         	select khoahoc.TenKH,khoahoc.GV,khoahoc.Ngaybatdau,khoahoc.Ngayketthuc,khoahoc.LichHoc,khoahoc.IDKH

				from khoahoc
				
								
						where khoahoc.IDKH=${param.id} 
		...
		<div class="container">
			...
			<div
				...
				<ul class="nav navbar-nav">
					<li><a href="HVindex.jsp">TRANG CHỦ</a></li>
			...
			<div class="row">
				<div class="col-sm-2">
					<ul class="nav nav-pills nav-stacked">
						...
						<li class="dropdown"><a class="dropdown-toggle r"
							data-toggle="dropdown" href="#">Khóa học <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a class="r" href="HVkhoahocdk.jsp">Khóa học DK</a></li>
								<li><a class="r" href="HVkhoahoc.jsp">Các Khóa học</a></li>
								<li><a class="r" href="HVdecuongchitiet.jsp">Chi tiết
										khóa học</a></li>
							</ul></li>
						<li class="dropdown"><a class="dropdown-toggle r"
							data-toggle="dropdown" href="#">Bài thi <span class="caret"></span></a>
							<ul class="dropdown-menu">
						...
						<li class="dropdown"><a class="dropdown-toggle r"
							data-toggle="dropdown" href="#">Tin nhắn <span class="caret"></span></a>
							<ul class="dropdown-menu">
									...
									<div class="panel panel-default">
										<c:forEach var="row" items="${result.rows}">
											<div class="panel-heading">
												...
												<h2 class="panel-heading" style="color: #7dc5f3;">
													<c:out value="${row.TenKH}" />
													- Giảng viên:
													<c:out value="${row.GV}" />
												</h2>
											</div>
												...
												<div class="col-md-12 content" style="margin-left: 100px">
													...
													<h4>
														<span class="glyphicon glyphicon-tags"></span><a
															href="HVhoctheotuan.jsp?id=<c:out value="${row.IDKH}" />">
															Các Bài Giảng</a>
													</h4>
													<h4>
														<span class="glyphicon glyphicon-tags"></span><a
															href="HVbttheotuan.jsp?id=<c:out value="${row.IDKH}" />">
															Các bài tập</a>
													</h4>
													<h4>
														<span class="glyphicon glyphicon-tags"></span><a
															href="HVxemdiem.jsp?id=<c:out value="${row.IDKH}" />">
															Xem điểm</a>
													</h4>
													<h4>
														<span class="glyphicon glyphicon-tags"></span><a
															href="danhgia.jsp?id=<c:out value="${row.IDKH}" />">
															Đánh giá</a>
													</h4>
												</div>
												<!--end content-->
