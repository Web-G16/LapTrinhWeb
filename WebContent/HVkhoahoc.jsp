						...
						<c:forEach var="row" items="${result.rows}">
							<tbody>
								...
								<tr>
									...
									<td><c:out value="${row.DiemDanhGia}" /></td>
									
									<td><a class="btn btn-primary btn-xs" 
										href="javascript:confirmGo('Bạn muốn đăng kí khóa học này?','dkmonhoc.jsp?id=
										<c:out value="${row.idkh}"/>')">  
