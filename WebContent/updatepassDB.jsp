						...
						<div id="main" ng-app="demoApp" ng-controller="RegisterCtrl">
								...
								<div class="form-group">
									<sql:setDataSource var="dbsource"
										...
										url="jdbc:mysql://node179275-group16.jelastic.servint.net/data?autoReconnect=true&useUnicode=true&characterEncoding=UTF-8" user="root"
										password="FZDool70036" />
        <sql:update dataSource="${dbsource}" var="count">
            UPDATE members SET pass = ?
            WHERE uname='${param.uname}' and pass= '${param.password1}'
            <sql:param value="${param.password}" />
        </sql:update>
       <c:choose>
										<c:when test="${count>=1}">
											<center>
												<font size="5" color='green'>Đổi mật khẩu thành công !</font>
											</center>
											<center>
												<p>
													<a href="HVthongtin.jsp">Quay lại</a>
												</p>
											</center>
										</c:when>
										<c:otherwise>
											<center><font size="5" color='green'> Đổi mật khẩu không thành
												công !</font></center>
											<p><h3><a href="HVthongtin.jsp">Quay lại</a></h3></p>
										</c:otherwise>
									</c:choose>
								</div>
						</div>
