...
.carousel-inner>.item>img, .carousel-inner>.item>a>img {
    ...
    <body>
        ...
        <sql:update dataSource="${dbsource}" var="count">
         ...
         INSERT INTO dkkh (IDKH,uname) value (?,'<%=session.getAttribute("userid")%>')
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-8 " style="margin-bottom: 20px">
					...
					<center><h3 class="tieude">Các khóa học đang mở</h3></center>
					<table class="table table-striped" style="background: white">
						<center><font size="5" color='green'>Đăng kí thành công thành công khoá học</font></center>
						 <center><a href="HVkhoahoc.jsp">Quay lại trang các khóa học đã mở</a> </center>
						  <center><a href="HVkhoahocdk.jsp">Đi tới trang đã đăng kí các khóa học</a> </center>
					</table>
