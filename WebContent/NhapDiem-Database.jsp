  ...
  .controller( "RegisterCtrl",['$scope', function($scope) {
	...
	<sql:setDataSource var="dbsource" driver="com.mysql.jdbc.Driver"
        ...
        <sql:update dataSource="${dbsource}" var="result">
            INSERT INTO diem( IDKH, Tuan , TenHV , Diem) VALUES (?,?,?,?)
  ...
  <div class="col-sm-9">
    <div class="row">
        ...
        <c:when test="${result>=1}">
            <font size="5" color='green'> Nhập điểm thành công</font>
            
              <a href="GVxembaitap.jsp?IDKH=${param.IDKH }">Quay lại</a>          
        </c:when>
        <c:otherwise>
        	<font size="5" color='green'> Nhập điểm không thành công</font>
