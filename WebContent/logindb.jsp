...
<body>
  ...
  .controller( "RegisterCtrl",['$scope', function($scope) {
    ...
    Connection con = DriverManager.getConnection("jdbc:mysql://node179311-group16wed.jelastic.servint.net/data?autoReconnect=true&useUnicode=true&characterEncoding=UTF-8", "root", "RAYatq42331");
