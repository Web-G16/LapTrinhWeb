  ...
  .controller( "RegisterCtrl",['$scope', function($scope) {
    ...
    <sql:setDataSource var="dbsource" driver="com.mysql.jdbc.Driver"
     ...
     <sql:update dataSource="${dbsource}" var="result">
            INSERT INTO diemthi( TenDeThi, GV , DiemThi , IDKH,username) VALUES (?,?,?,?,?)
            <sql:param value="${param.tendethi}" /> 
            <sql:param value="${param.GV}" /> 
...
<div class="row">
  ...
  <div class="col-sm-9">
    <div class="row">
       <center><h3 class="tieude">Danh sách điểm các bài thi</h3></center>
					<table class="table table-striped" style="background: white">
						<center><h3>Bạn đã hoàn thành xong bài thi</h3></center>
						<center><a href="HVdiembaithi.jsp"><h3>Quay lại trang điểm thi cá nhân</h3></a></center>
