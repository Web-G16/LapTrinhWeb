				...
				<div class="col-sm-3">
					<ul class="nav nav-pills nav-stacked">
						...
						<li class="dropdown"><a class="dropdown-toggle r"
							...
							<ul class="dropdown-menu">
								<li><a class="r" href="GVCackhoahocdamo.jsp">Khóa học
										đã mở</a></li>
						...
						<li>
						<li class="dropdown"><a class="dropdown-toggle r"
							data-toggle="dropdown" href="#">Bài tập - Đề thi <span
								class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a class="r" href="GVrabaitap.jsp">Ra bài tập</a></li>
								<li><a class="r" href="GVradethi.jsp">Ra đề thi</a></li>
								<li><a class="r" href="GVdsbaitapnop.jsp">Danh sách bài
										tập đã nộp</a></li>
				...
				<div class="col-sm-9">
					<div class="row">
						...
						<div class="col-md-12" style="border: 1px solid black">
							...
							<h3 class="tieude">Quản lý khóa học</h3>
							
							<form method="post" enctype="multipart/form-data" action="upbg">
								...
								<tbody>
											...
											<tr>
												...
												<td>
													...
													<input type="text" value="${row.Tuan}" name="Tuan"/>
													<input type="hidden" value="${row.ID}" name="ID"/>
												</td>

											</tr>
											<tr>
												<td>Tên bài giảng</td>
												<td><input type="text" value="${row.TenBaiGiang}" name="BaiGiang"/></td>
											</tr>
											<tr>
												<td>Link Video</td>
												<td><input type="text" value="${row.LinkVideo}" name="LinkVideo"/></td>
											</tr>
											<tr>
												<td>Tên đề cương</td>
												<td><input type="text" value="${row.decuong}" name="tailieu"/></td>
											</tr>
											<tr>
												<td>liên kết</td>
