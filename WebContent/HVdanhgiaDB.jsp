  ...
  <div class="col-sm-9">
    <div class="row">
        ...
        <h2 class="text-center" style="background:#333;color:#0adb48">THÔNG BÁO</h2>
        		<center>
				<h3><font size="5" color='green'>Đánh giá thành công  !</font></h3>
					<a href="HVhoc.jsp?id=${param.IDKH }">Quay lại</a>
					
				</center>
		        <%
		    
			String idkh=request.getParameter("IDKH");
		    float  op = Float.parseFloat(request.getParameter("optradio"));
		    float  op1 = Float.parseFloat(request.getParameter("optradio1"));
		    float  op2 = Float.parseFloat(request.getParameter("optradio2"));
		    float  op3 = Float.parseFloat(request.getParameter("optradio3"));
		    float  op4 = Float.parseFloat(request.getParameter("optradio4"));
		    float  op5 = Float.parseFloat(request.getParameter("optradio5"));
		    float  op6 = Float.parseFloat(request.getParameter("optradio6"));
		    float  op8 = Float.parseFloat(request.getParameter("optradio8"));
		    float diem= op+op1+op2+op3+op4+op5+op6+op8;
		    Class.forName("com.mysql.jdbc.Driver");
		    Connection con = DriverManager.getConnection("jdbc:mysql://node179311-group16wed.jelastic.servint.net/data?autoReconnect=true&useUnicode=true&characterEncoding=UTF-8",
		            "root", "RAYatq42331");
		    Statement st = con.createStatement();
		    //ResultSet rs;
		    int i = st.executeUpdate( " UPDATE khoahoc set DiemDanhGia=' " + diem + "' where IDKH='" + idkh + "' ");
