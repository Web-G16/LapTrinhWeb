  ...
  .controller( "RegisterCtrl",['$scope', function($scope) {
    ...
    <sql:setDataSource var="dbsource" driver="com.mysql.jdbc.Driver"
			...
			<sql:query dataSource="${dbsource}" var="result">
            				SELECT khoahoc.TenKH, khoahoc.Ngaybatdau, khoahoc.Ngayketthuc, khoahoc.LichHoc, khoahoc.IDKH
  ...
  <li><li class="dropdown">
    ...
    <div class="row" >
      ...
      <div class="col-md-12 all">
        <div class="post">
              <div class="row">
                <center><h3 class ="tieude">DANH SÁCH BÀI TẬP ĐÃ NỘP</h3></center>
        ...
        <thead>
                        <tr>
                            ...
                            <th width="60%">Danh sách bài tập đã nộp</th>
                    ...
                    <c:forEach var="row" items="${result.rows}">
											<tbody>
												...
												<tr>
													...
													<td><a href=""> <c:out value="${row.TenKH}" /></a></td> 
													
													<td><a href="GVxembaitap.jsp?IDKH=<c:out value="${row.IDKH}"/>">Xem</a>
