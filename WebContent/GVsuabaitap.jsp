				...
				<div class="col-sm-9">
					<div class="row">
						...
						<div class="col-md-12" style="border: 1px solid black">
							...
							<form method="post" enctype="multipart/form-data" action="editbt">
							...
							<table class="table table-striped">
								<tbody>
											...
											<tr>
												<td>Tên bài tập</td>
												<td><input type="text" value="${row.TenBaiTap}" name="TenBaiTap"/></td>
											</tr>
											
											<tr>
												<td>Upload bài tập</td>
												<td><input type="file" name = "LinkBaiTap"></td>
											</tr>
