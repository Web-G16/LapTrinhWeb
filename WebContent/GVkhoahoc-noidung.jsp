  ...
  .controller( "RegisterCtrl",['$scope', function($scope) {
    ...
    <!--End Header section  -->
			...
			<sql:query dataSource="${dbsource}" var="result">
            				...
            				where khoahoc.GV='<%=session.getAttribute("userid")%>' 
  ...
  <div class="col-sm-9">
    <div class="row">
      ...
      <div class="col-md-12" style="border:1px solid black">
        ...
        <center><h3 class="tieude">Quản lý khóa học</h3></center>
       
        <table class="table table-striped">
        
      	 
                
				<h4><span class="glyphicon glyphicon-folder-open"></span><a href="GVquanlytailieu.jsp?IDKH=${param.IDKH}">  Quản lý khóa học - Tài liệu</a></h4>
                <h4><span class="glyphicon glyphicon-folder-open"></span><a href="ListHocVien.jsp?IDKH=${param.IDKH}"> Quản lý học viên</a></h4>
                <h4><span class="glyphicon glyphicon-folder-open"></span><a href="GVquanlybaitap.jsp?IDKH=${param.IDKH}">  Quản lý khóa học - Bài tập</a></h4>
                <h4><span class="glyphicon glyphicon-folder-open"></span><a href="GVthongbao.jsp?IDKH=${param.IDKH }">  Thông báo</a></h4>
