  ...
  <div class="col-sm-9">
    <div class="row">
      ...
      <div class="col-md-12" style="border:1px solid black; margin-top:30px">
        <h3 class="tieude">Các bài tập học viên đã nộp</h3>
                    ...
                    <c:forEach var="row" items="${result.rows}">
											<tbody>
												...
												<tr>
													...
													<td><a href="NhapDiem.jsp?id=<c:out value="${row.ID}"/>&IDKH=<c:out value="${row.IDKH}"/>&TenHV=<c:out value="${row.user}"/>&Tuan=<c:out value="${row.Tuan}"/>">Nhập điểm</a></td>
