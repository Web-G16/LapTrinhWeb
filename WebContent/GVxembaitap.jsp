...
<body>
  ...
  .controller( "RegisterCtrl",['$scope', function($scope) {
	...
	<sql:setDataSource var="dbsource" driver="com.mysql.jdbc.Driver"
         		...
         		select hvbaitap.user,hvbaitap.Tuan,hvbaitap.TenBaiTap,hvbaitap.ID

				from hvbaitap
				
								
				where hvbaitap.IDKH=${param.IDKH} 
...
<div class="row">
  ...
  <div class="col-sm-9">
    <div class="row">
      ...
      <div class="col-md-12" style="border:1px solid black; margin-top:30px">
        <center><h3 class="tieude">Các bài tập học viên đã nộp</h3></center>
                    ...
                    <c:forEach var="row" items="${result.rows}">
											<tbody>
												...
												<tr>
													...
													<td><a href="downBaiTap.jsp?id=<c:out value="${row.ID}"/>"><span class="glyphicon glyphicon-download-alt"></span><c:out value="${row.TenBaiTap}" /></a></td>
													
													<td><a href="NhapDiem.jsp?id=<c:out value="${row.ID}"/>&IDKH=<c:out value="${param.IDKH}"/>&TenHV=<c:out value="${row.user}"/>&Tuan=<c:out value="${row.Tuan}"/>">Nhập điểm</a></td>
