							...
							<div class="col-md-12">
								<div class="table-responsive">
									...
									<sql:setDataSource var="dbsource"
										...
										url="jdbc:mysql://node179275-group16.jelastic.servint.net/data" user="root"
									...
									<c:if test="${count>=1}">
										<center><font size="5" color='green'> Xóa thành công tài khoản</font></center>
										<center><p><a href="ADquanlitaikhoan.jsp">Quay lại</a></p></center>
									</c:if>
