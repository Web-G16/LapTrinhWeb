				...
				<div class="col-sm-9">
					<div class="row">
						...
						<div class="col-md-12" style="border: 1px solid black">
							...
							<h3 class="tieude">Chấm điểm</h3>
							<form action="NhapDiem-Database.jsp"><table class="table table-striped">
								<tbody>
											...
											<tr>
												...
												<td>
													...
													<input type="text" value="${param.Tuan}" name="Tuan"/>
											...
											<tr>
												<td>Tên học viên</td>
												<td><input type="text" value="${param.TenHV}" name="TenHV"/></td>
											</tr>
											<tr>
												<td>Điểm</td>
