    ...
    <!--End Header section  -->
     ...
     <!--End Navigation -->
        ...
        <sql:query dataSource="${dbsource}" var="result">
            SELECT * from members where role= "gv";
...
<div class="row">
 ...
 <tr>
    ...
    <td><a class="btn btn-primary btn-xs" href="HVndtngv.jsp?to=<c:out value="${row.email}"/>"><span class="glyphicon glyphicon-envelope"></span></a></td>
    </tr>   
    </tbody>
     </c:forEach>   
        </table>
