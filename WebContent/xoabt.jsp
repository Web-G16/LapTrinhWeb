      ...
      <div class="col-md-12" >
        ...
        <c:if test="${count>=1}">
            <font size="5" color='green'> Congratulations ! Data deleted successfully.</font>
              ...
              <a href="GVquanlybaitap.jsp?IDKH=<c:out value="${param.IDKH}"/>">Go Home</a>   
...
<div class="row">
  ...
  <div class="col-sm-9">
    <div class="row">
        ...
        <ul>
          <c:if test="${count>=1}">
            <center><font size="5" color='green'> Xóa thành công </font></center>
        
              <center><a href="GVquanlytailieu.jsp?IDKH=<c:out value="${param.IDKH}"/>">Quay lại</a>  </center> 
