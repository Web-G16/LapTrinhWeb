  ...
  <div class="col-sm-9">
    <div class="row">
      ...
      <div class="col-md-12" style="border:1px solid black">
        <center><h3 class="tieude">Các khóa học đã mở</h3></center>
                    ...
                    <c:forEach var="row" items="${result.rows}">
											<tbody>
												...
												<tr>
													...
													<td><a href="GVkhoahoc-noidung.jsp?IDKH=<c:out value="${row.IDKH}"/>"><c:out value="${row.TenKH}" /></a></td> 
													<td><c:out value="${row.Ngaybatdau}" /></td>
													<td><c:out value="${row.Ngayketthuc}" /></td>
													<td><c:out value="${row.LichHoc}" /></td>
