...
<div class="row">
  ...
  <div class="col-sm-9">
    <div class="row">
      ...
      <form action="GVthongbaoDB.jsp">
        <center><h3 class="tieude">Thông báo</h3></center>
      	 		 ...
      	 		 <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" value="${row.IDKH}" name="IDKH" />
                                  	<input type="hidden" value="${row.TenKH}" name="TenKH" />
                                </div>
                                
                                 <center><button type="submit" class="btn btn-primary">Xácnhận</button></center>
                            </div>
                 </c:forEach>
