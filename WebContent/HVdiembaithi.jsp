    ...
    <!--End Header section  -->
		<sql:setDataSource var="dbsource" driver="com.mysql.jdbc.Driver"
     			...
     			<sql:query dataSource="${dbsource}" var="result">
         				   SELECT  diemthi.TenDeThi,diemthi.DiemThi,khoahoc.TenKH
         				   from diemthi,khoahoc
         				   where 
									diemthi.IDKH=khoahoc.IDKH and 
                                    
										diemthi.username='<%=session.getAttribute("userid")%>'
