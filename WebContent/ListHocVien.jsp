...
<body>
  ...
  .controller( "RegisterCtrl",['$scope', function($scope) {
	...
	<sql:query dataSource="${dbsource}" var="result">
            				SELECT members.name, members.email, members.birdday, members.phone
            				
            				from members,dkkh
            				
            				where dkkh.uname=members.uname and dkkh.IDKH=${param.IDKH} 
				...
				<div class="col-sm-9">
					<div class="row">
						...
						<div class="col-md-12" style="border: 1px solid black">
							<center><h3 class="tieude">Danh sách các học viên</h3></center>
								...
								<c:forEach var="row" items="${result.rows}">
									<tbody>
										...
										<tr>
											...
											<td><a href="GVmessHV-ND.jsp?to=<c:out value="${row.email}"/>">Liên hệ</a></td>
